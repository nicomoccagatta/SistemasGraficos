...
function Bridge(base_height, max_height, center_x, number_of_columns, from, to) {
    ...
    var separation_between_columns = (position_last_column - position_first_column) / (number_of_columns - 1);
    
    for (var i = 0; i < number_of_columns; i++) {
        var this_step_center_y = position_first_column + i * separation_between_columns;
        ...
        if (i < (number_of_columns - 1)) {
            var next_step_center_y = position_first_column + (i + 1) * separation_between_columns;
